...
export function setupButtonsContainer(context) {
    ...
    if (!context.switchCameraButton) {
        context.switchCameraButton = document.createElement("button");
    ...
    if (!context.closeScannerButton) {
        context.closeScannerButton = document.createElement("button");
        ...
        context.closeScannerButton.style.fontSize = "20px";
...
export function closeScanner(context) {
    ...
    if (context.scannerButtonElement)
